...
namespace WebApi.Controllers
{
  ...
  public class BookController:ControllerBase
  {
     ...
     */
     ...
     //*Refactored UpdateBook() which takes a model as a parameter from body instead of an entity and it takes a title as a parameter instead of an id;
     [HttpPut("{title}")]
     public IActionResult UpdateBook(string title, [FromBody] UpdateBookModel updatedBook)
     {
