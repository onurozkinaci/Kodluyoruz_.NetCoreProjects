...
namespace WebApi.Middlewares
{
    public class CustomExceptionMiddleware
    {
      ...
      public async Task Invoke(HttpContext context)
      {
         ...
         catch (Exception ex) //endpoint cagrilirken(next ile bir sonraki middleware cagrildiginda herhangi bir
         //hata alinirsa (validation veya servis tanimi(CreateAuthorCommand.cs gibi) kaynakli gibi) bu hata burada direkt yakalanip
         //Json formatinda response olarak donduruleceginden, Controllerlar icinde validator.ValidateAndThrow() kullanirken artik try-catch '
         //ile bunu sarmalamaya gerek yoktur, cunku hata direkt burada yakalanabilecek duruma getirildi.
         {
    ...
    //startup.cs'de app. prefix'i(IApplicationBuilder'i this ile parametre olarak vererek-extension metot
    //ozelligi vermek icin) ile cagirabilmek icin Extension metot tanimlanir;
